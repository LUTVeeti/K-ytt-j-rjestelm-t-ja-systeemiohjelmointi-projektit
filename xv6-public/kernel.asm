...
801024d2:	81 fb f0 54 11 80    	cmp    $0x801154f0,%ebx
...
80103077:	68 f0 54 11 80       	push   $0x801154f0
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 94 59 10 80 	movl   $0x80105994,0x14(%eax)
  p->context = (struct context*)sp;
...
801039b3:	e8 c8 35 00 00       	call   80106f80 <setupkvm>
...
801039d1:	e8 5a 32 00 00       	call   80106c30 <inituvm>
...
80103abb:	e8 60 30 00 00       	call   80106b20 <switchuvm>
  return 0;
...
80103b48:	e8 23 35 00 00       	call   80107070 <copyuvm>
...
80103c80:	e8 9b 2e 00 00       	call   80106b20 <switchuvm>
...
80103c92:	e8 e4 0b 00 00       	call   8010487b <swtch>
      switchkvm();
80103c97:	e8 74 2e 00 00       	call   80106b10 <switchkvm>
      c->proc = 0;
...
80103f89:	e8 72 2f 00 00       	call   80106f00 <freevm>
        p->pid = 0;
...
801041fb:	68 3b 7c 10 80       	push   $0x80107c3b
...
struct syscall_stats sys_stats = {0, 0, 0, 0};
...
80104a7a:	77 34                	ja     80104ab0 <syscall+0x50>
80104a7c:	8b 14 85 a0 79 10 80 	mov    -0x7fef8660(,%eax,4),%edx
80104a83:	85 d2                	test   %edx,%edx
80104a85:	74 29                	je     80104ab0 <syscall+0x50>
    
    switch(num) {
80104a87:	83 f8 10             	cmp    $0x10,%eax
80104a8a:	74 64                	je     80104af0 <syscall+0x90>
80104a8c:	77 4a                	ja     80104ad8 <syscall+0x78>
80104a8e:	83 f8 05             	cmp    $0x5,%eax
80104a91:	74 6d                	je     80104b00 <syscall+0xa0>
80104a93:	83 f8 0f             	cmp    $0xf,%eax
80104a96:	75 07                	jne    80104a9f <syscall+0x3f>
        break;
      case SYS_write:
        sys_stats.write_count++;
        break;
      case SYS_open:
        sys_stats.open_count++;
80104a98:	83 05 60 3c 11 80 01 	addl   $0x1,0x80113c60
        break;
      case SYS_close:
        sys_stats.close_count++;
        break;
    }
    curproc->tf->eax = syscalls[num]();
80104a9f:	ff d2                	call   *%edx
80104aa1:	89 c2                	mov    %eax,%edx
80104aa3:	8b 43 18             	mov    0x18(%ebx),%eax
80104aa6:	89 50 1c             	mov    %edx,0x1c(%eax)
  } else {
...
80104ab8:	68 7d 79 10 80       	push   $0x8010797d
...
80104ad4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    switch(num) {
80104ad8:	83 f8 15             	cmp    $0x15,%eax
80104adb:	75 c2                	jne    80104a9f <syscall+0x3f>
        sys_stats.close_count++;
80104add:	83 05 64 3c 11 80 01 	addl   $0x1,0x80113c64
        break;
80104ae4:	eb b9                	jmp    80104a9f <syscall+0x3f>
80104ae6:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80104aed:	8d 76 00             	lea    0x0(%esi),%esi
        sys_stats.write_count++;
80104af0:	83 05 5c 3c 11 80 01 	addl   $0x1,0x80113c5c
        break;
80104af7:	eb a6                	jmp    80104a9f <syscall+0x3f>
80104af9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
        sys_stats.read_count++;
80104b00:	83 05 58 3c 11 80 01 	addl   $0x1,0x80113c58
        break;
80104b07:	eb 96                	jmp    80104a9f <syscall+0x3f>
...
80104c44:	68 18 7a 10 80       	push   $0x80107a18
...
80104c5c:	68 17 7a 10 80       	push   $0x80107a17
...
80104c71:	68 0b 7a 10 80       	push   $0x80107a0b
...
80104c8f:	68 1a 7a 10 80       	push   $0x80107a1a
80104c94:	e8 e7 b6 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104c99:	83 ec 0c             	sub    $0xc,%esp
80104c9c:	68 fc 79 10 80       	push   $0x801079fc
...
8010509d:	58                   	pop    %eax
8010509e:	5a                   	pop    %edx
8010509f:	68 18 7a 10 80       	push   $0x80107a18
...
801050b8:	68 17 7a 10 80       	push   $0x80107a17
...
80105384:	e8 57 f6 ff ff       	call   801049e0 <argstr>
...
801053e4:	e8 f7 f5 ff ff       	call   801049e0 <argstr>
...
801053f9:	e8 22 f5 ff ff       	call   80104920 <argint>
  if((argstr(0, &path)) < 0 ||
...
8010540e:	e8 0d f5 ff ff       	call   80104920 <argint>
     argint(1, &major) < 0 ||
...
80105465:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105468:	e8 03 e5 ff ff       	call   80103970 <myproc>
...
8010547d:	e8 5e f5 ff ff       	call   801049e0 <argstr>
...
80105525:	e8 b6 f4 ff ff       	call   801049e0 <argstr>
...
80105541:	e8 da f3 ff ff       	call   80104920 <argint>
...
80105560:	e8 fb f0 ff ff       	call   80104660 <memset>
...
8010558a:	e8 01 f3 ff ff       	call   80104890 <fetchint>
...
801055a8:	e8 23 f3 ff ff       	call   801048d0 <fetchstr>
...
80105611:	e8 5a f3 ff ff       	call   80104970 <argptr>
...
80105637:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105639:	e8 32 e3 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801057c0:	68 a0 3c 11 80       	push   $0x80113ca0
801057c5:	e8 d6 ed ff ff       	call   801045a0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801057ca:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801057cd:	8b 1d 80 3c 11 80    	mov    0x80113c80,%ebx
  while(ticks - ticks0 < n){
...
801057e3:	68 a0 3c 11 80       	push   $0x80113ca0
801057e8:	68 80 3c 11 80       	push   $0x80113c80
801057ed:	e8 4e e8 ff ff       	call   80104040 <sleep>
  while(ticks - ticks0 < n){
801057f2:	a1 80 3c 11 80       	mov    0x80113c80,%eax
...
80105810:	68 a0 3c 11 80       	push   $0x80113ca0
...
80105833:	68 a0 3c 11 80       	push   $0x80113ca0
...
80105854:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105857:	68 a0 3c 11 80       	push   $0x80113ca0
8010585c:	e8 3f ed ff ff       	call   801045a0 <acquire>
  xticks = ticks;
80105861:	8b 1d 80 3c 11 80    	mov    0x80113c80,%ebx
  release(&tickslock);
80105867:	c7 04 24 a0 3c 11 80 	movl   $0x80113ca0,(%esp)
...
80105896:	79 07                	jns    8010589f <sys_getreadcount+0x1f>
    type = 0;  
80105898:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
...
801058a8:	e8 73 f0 ff ff       	call   80104920 <argint>
801058ad:	83 c4 10             	add    $0x10,%esp
801058b0:	85 c0                	test   %eax,%eax
801058b2:	78 5c                	js     80105910 <sys_getreadcount+0x90>
    reset = 0;
...
801058b7:	83 f8 02             	cmp    $0x2,%eax
801058ba:	0f 84 a0 00 00 00    	je     80105960 <sys_getreadcount+0xe0>
801058c0:	83 f8 02             	cmp    $0x2,%eax
801058c3:	7f 2b                	jg     801058f0 <sys_getreadcount+0x70>
801058c5:	85 c0                	test   %eax,%eax
801058c7:	74 77                	je     80105940 <sys_getreadcount+0xc0>
801058c9:	83 f8 01             	cmp    $0x1,%eax
801058cc:	75 62                	jne    80105930 <sys_getreadcount+0xb0>
...
801058ce:	8b 55 f4             	mov    -0xc(%ebp),%edx
      count = sys_stats.write_count;
801058d1:	a1 5c 3c 11 80       	mov    0x80113c5c,%eax
      if(reset) 
801058d6:	85 d2                	test   %edx,%edx
801058d8:	74 0a                	je     801058e4 <sys_getreadcount+0x64>
        sys_stats.write_count = 0;
801058da:	c7 05 5c 3c 11 80 00 	movl   $0x0,0x80113c5c
801058e1:	00 00 00 
    default:
      count = -1;  
  }
...
801058ed:	8d 76 00             	lea    0x0(%esi),%esi
  switch(type) {
801058f0:	83 f8 03             	cmp    $0x3,%eax
801058f3:	75 3b                	jne    80105930 <sys_getreadcount+0xb0>
      if(reset) 
801058f5:	8b 55 f4             	mov    -0xc(%ebp),%edx
      count = sys_stats.close_count;
801058f8:	a1 64 3c 11 80       	mov    0x80113c64,%eax
      if(reset) 
801058fd:	85 d2                	test   %edx,%edx
801058ff:	74 e3                	je     801058e4 <sys_getreadcount+0x64>
        sys_stats.close_count = 0;
80105901:	c7 05 64 3c 11 80 00 	movl   $0x0,0x80113c64
80105908:	00 00 00 
8010590b:	c9                   	leave  
8010590c:	c3                   	ret    
...
80105910:	8b 45 f0             	mov    -0x10(%ebp),%eax
    reset = 0;
80105913:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  switch(type) {
8010591a:	83 f8 02             	cmp    $0x2,%eax
8010591d:	75 a1                	jne    801058c0 <sys_getreadcount+0x40>
      count = sys_stats.open_count;
8010591f:	a1 60 3c 11 80       	mov    0x80113c60,%eax
80105924:	c9                   	leave  
80105925:	c3                   	ret    
...
8010593e:	66 90                	xchg   %ax,%ax
      if(reset) 
80105940:	8b 4d f4             	mov    -0xc(%ebp),%ecx
      count = sys_stats.read_count;
80105943:	a1 58 3c 11 80       	mov    0x80113c58,%eax
      if(reset) 
80105948:	85 c9                	test   %ecx,%ecx
8010594a:	74 98                	je     801058e4 <sys_getreadcount+0x64>
        sys_stats.read_count = 0;
8010594c:	c7 05 58 3c 11 80 00 	movl   $0x0,0x80113c58
80105953:	00 00 00 
80105956:	c9                   	leave  
80105957:	c3                   	ret    
...
8010595f:	90                   	nop
      if(reset) 
80105960:	8b 4d f4             	mov    -0xc(%ebp),%ecx
      count = sys_stats.open_count;
80105963:	a1 60 3c 11 80       	mov    0x80113c60,%eax
      if(reset) 
80105968:	85 c9                	test   %ecx,%ecx
8010596a:	0f 84 74 ff ff ff    	je     801058e4 <sys_getreadcount+0x64>
        sys_stats.open_count = 0;
80105970:	c7 05 60 3c 11 80 00 	movl   $0x0,0x80113c60
80105977:	00 00 00 
8010597a:	c9                   	leave  
8010597b:	c3                   	ret    
...
8010597d:	06                   	push   %es
  pushl %fs
8010597e:	0f a0                	push   %fs
  pushl %gs
80105980:	0f a8                	push   %gs
  pushal
80105982:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105983:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105987:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105989:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
8010598b:	54                   	push   %esp
  call trap
8010598c:	e8 bf 00 00 00       	call   80105a50 <trap>
  addl $4, %esp
80105991:	83 c4 04             	add    $0x4,%esp
...
80105994:	61                   	popa   
  popl %gs
80105995:	0f a9                	pop    %gs
  popl %fs
80105997:	0f a1                	pop    %fs
  popl %es
80105999:	07                   	pop    %es
  popl %ds
8010599a:	1f                   	pop    %ds
...
801059b7:	c7 04 c5 e2 3c 11 80 	movl   $0x8e000008,-0x7feec31e(,%eax,8)
801059be:	08 00 00 8e 
801059c2:	66 89 14 c5 e0 3c 11 	mov    %dx,-0x7feec320(,%eax,8)
801059c9:	80 
801059ca:	c1 ea 10             	shr    $0x10,%edx
801059cd:	66 89 14 c5 e6 3c 11 	mov    %dx,-0x7feec31a(,%eax,8)
801059d4:	80 
  for(i = 0; i < 256; i++)
...
801059e7:	c7 05 e2 3e 11 80 08 	movl   $0xef000008,0x80113ee2
801059ee:	00 00 ef 
  initlock(&tickslock, "time");
801059f1:	68 5d 7a 10 80       	push   $0x80107a5d
801059f6:	68 a0 3c 11 80       	push   $0x80113ca0
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801059fb:	66 a3 e0 3e 11 80    	mov    %ax,0x80113ee0
80105a01:	c1 e8 10             	shr    $0x10,%eax
80105a04:	66 a3 e6 3e 11 80    	mov    %ax,0x80113ee6
  initlock(&tickslock, "time");
80105a0a:	e8 c1 e9 ff ff       	call   801043d0 <initlock>
}
...
80105a2b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105a2f:	b8 e0 3c 11 80       	mov    $0x80113ce0,%eax
...
80105b62:	e8 09 de ff ff       	call   80103970 <myproc>
...
80105b84:	0f 85 3e ff ff ff    	jne    80105ac8 <trap+0x78>
    yield();
80105b8a:	e8 61 e4 ff ff       	call   80103ff0 <yield>
...
80105b9f:	e8 ac dd ff ff       	call   80103950 <cpuid>
...
80105bb6:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105bb9:	e8 b2 dd ff ff       	call   80103970 <myproc>
...
80105be5:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105be8:	e8 73 ee ff ff       	call   80104a60 <syscall>
    if(myproc()->killed)
80105bed:	e8 7e dd ff ff       	call   80103970 <myproc>
...
80105c03:	5d                   	pop    %ebp
      exit();
80105c04:	e9 87 e1 ff ff       	jmp    80103d90 <exit>
...
80105c60:	68 a0 3c 11 80       	push   $0x80113ca0
80105c65:	e8 36 e9 ff ff       	call   801045a0 <acquire>
      wakeup(&ticks);
80105c6a:	c7 04 24 80 3c 11 80 	movl   $0x80113c80,(%esp)
      ticks++;
80105c71:	83 05 80 3c 11 80 01 	addl   $0x1,0x80113c80
      wakeup(&ticks);
80105c78:	e8 83 e4 ff ff       	call   80104100 <wakeup>
      release(&tickslock);
80105c7d:	c7 04 24 a0 3c 11 80 	movl   $0x80113ca0,(%esp)
80105c84:	e8 b7 e8 ff ff       	call   80104540 <release>
...
{
  if(!uart)
80105ce0:	a1 e0 44 11 80       	mov    0x801144e0,%eax
...
80105d67:	74 78                	je     80105de1 <uartinit+0xd1>
  uart = 1;
80105d69:	c7 05 e0 44 11 80 01 	movl   $0x1,0x801144e0
80105d70:	00 00 00 
...
80105d99:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105da0:	a1 e0 44 11 80       	mov    0x801144e0,%eax
...
80105df0 <uartputc>:
  if(!uart)
80105df0:	a1 e0 44 11 80       	mov    0x801144e0,%eax
...
80105e67:	6a 00                	push   $0x0
  jmp alltraps
80105e69:	e9 0e fb ff ff       	jmp    8010597c <alltraps>
...
80105e70:	6a 01                	push   $0x1
  jmp alltraps
80105e72:	e9 05 fb ff ff       	jmp    8010597c <alltraps>
...
80105e79:	6a 02                	push   $0x2
  jmp alltraps
80105e7b:	e9 fc fa ff ff       	jmp    8010597c <alltraps>
...
80105e82:	6a 03                	push   $0x3
  jmp alltraps
80105e84:	e9 f3 fa ff ff       	jmp    8010597c <alltraps>
...
80105e8b:	6a 04                	push   $0x4
  jmp alltraps
80105e8d:	e9 ea fa ff ff       	jmp    8010597c <alltraps>
...
80105e94:	6a 05                	push   $0x5
  jmp alltraps
80105e96:	e9 e1 fa ff ff       	jmp    8010597c <alltraps>
...
80105e9d:	6a 06                	push   $0x6
  jmp alltraps
80105e9f:	e9 d8 fa ff ff       	jmp    8010597c <alltraps>
...
80105ea6:	6a 07                	push   $0x7
  jmp alltraps
80105ea8:	e9 cf fa ff ff       	jmp    8010597c <alltraps>
...
80105ead:	6a 08                	push   $0x8
  jmp alltraps
80105eaf:	e9 c8 fa ff ff       	jmp    8010597c <alltraps>
...
80105eb6:	6a 09                	push   $0x9
  jmp alltraps
80105eb8:	e9 bf fa ff ff       	jmp    8010597c <alltraps>
...
80105ebd:	6a 0a                	push   $0xa
  jmp alltraps
80105ebf:	e9 b8 fa ff ff       	jmp    8010597c <alltraps>
...
80105ec4:	6a 0b                	push   $0xb
  jmp alltraps
80105ec6:	e9 b1 fa ff ff       	jmp    8010597c <alltraps>
...
80105ecb:	6a 0c                	push   $0xc
  jmp alltraps
80105ecd:	e9 aa fa ff ff       	jmp    8010597c <alltraps>
...
80105ed2:	6a 0d                	push   $0xd
  jmp alltraps
80105ed4:	e9 a3 fa ff ff       	jmp    8010597c <alltraps>
...
80105ed9:	6a 0e                	push   $0xe
  jmp alltraps
80105edb:	e9 9c fa ff ff       	jmp    8010597c <alltraps>
...
80105ee2:	6a 0f                	push   $0xf
  jmp alltraps
80105ee4:	e9 93 fa ff ff       	jmp    8010597c <alltraps>
...
80105eeb:	6a 10                	push   $0x10
  jmp alltraps
80105eed:	e9 8a fa ff ff       	jmp    8010597c <alltraps>
...
80105ef2:	6a 11                	push   $0x11
  jmp alltraps
80105ef4:	e9 83 fa ff ff       	jmp    8010597c <alltraps>
...
80105efb:	6a 12                	push   $0x12
  jmp alltraps
80105efd:	e9 7a fa ff ff       	jmp    8010597c <alltraps>
...
80105f04:	6a 13                	push   $0x13
  jmp alltraps
80105f06:	e9 71 fa ff ff       	jmp    8010597c <alltraps>
...
80105f0d:	6a 14                	push   $0x14
  jmp alltraps
80105f0f:	e9 68 fa ff ff       	jmp    8010597c <alltraps>
...
80105f16:	6a 15                	push   $0x15
  jmp alltraps
80105f18:	e9 5f fa ff ff       	jmp    8010597c <alltraps>
...
80105f1f:	6a 16                	push   $0x16
  jmp alltraps
80105f21:	e9 56 fa ff ff       	jmp    8010597c <alltraps>
...
80105f28:	6a 17                	push   $0x17
  jmp alltraps
80105f2a:	e9 4d fa ff ff       	jmp    8010597c <alltraps>
...
80105f31:	6a 18                	push   $0x18
  jmp alltraps
80105f33:	e9 44 fa ff ff       	jmp    8010597c <alltraps>
...
80105f3a:	6a 19                	push   $0x19
  jmp alltraps
80105f3c:	e9 3b fa ff ff       	jmp    8010597c <alltraps>
...
80105f43:	6a 1a                	push   $0x1a
  jmp alltraps
80105f45:	e9 32 fa ff ff       	jmp    8010597c <alltraps>
...
80105f4c:	6a 1b                	push   $0x1b
  jmp alltraps
80105f4e:	e9 29 fa ff ff       	jmp    8010597c <alltraps>
...
80105f55:	6a 1c                	push   $0x1c
  jmp alltraps
80105f57:	e9 20 fa ff ff       	jmp    8010597c <alltraps>
...
80105f5e:	6a 1d                	push   $0x1d
  jmp alltraps
80105f60:	e9 17 fa ff ff       	jmp    8010597c <alltraps>
...
80105f67:	6a 1e                	push   $0x1e
  jmp alltraps
80105f69:	e9 0e fa ff ff       	jmp    8010597c <alltraps>
...
80105f70:	6a 1f                	push   $0x1f
  jmp alltraps
80105f72:	e9 05 fa ff ff       	jmp    8010597c <alltraps>
...
80105f79:	6a 20                	push   $0x20
  jmp alltraps
80105f7b:	e9 fc f9 ff ff       	jmp    8010597c <alltraps>
...
80105f82:	6a 21                	push   $0x21
  jmp alltraps
80105f84:	e9 f3 f9 ff ff       	jmp    8010597c <alltraps>
...
80105f8b:	6a 22                	push   $0x22
  jmp alltraps
80105f8d:	e9 ea f9 ff ff       	jmp    8010597c <alltraps>
...
80105f94:	6a 23                	push   $0x23
  jmp alltraps
80105f96:	e9 e1 f9 ff ff       	jmp    8010597c <alltraps>
...
80105f9d:	6a 24                	push   $0x24
  jmp alltraps
80105f9f:	e9 d8 f9 ff ff       	jmp    8010597c <alltraps>
...
80105fa6:	6a 25                	push   $0x25
  jmp alltraps
80105fa8:	e9 cf f9 ff ff       	jmp    8010597c <alltraps>
...
80105faf:	6a 26                	push   $0x26
  jmp alltraps
80105fb1:	e9 c6 f9 ff ff       	jmp    8010597c <alltraps>
...
80105fb8:	6a 27                	push   $0x27
  jmp alltraps
80105fba:	e9 bd f9 ff ff       	jmp    8010597c <alltraps>
...
80105fc1:	6a 28                	push   $0x28
  jmp alltraps
80105fc3:	e9 b4 f9 ff ff       	jmp    8010597c <alltraps>
...
80105fca:	6a 29                	push   $0x29
  jmp alltraps
80105fcc:	e9 ab f9 ff ff       	jmp    8010597c <alltraps>
...
80105fd3:	6a 2a                	push   $0x2a
  jmp alltraps
80105fd5:	e9 a2 f9 ff ff       	jmp    8010597c <alltraps>
...
80105fdc:	6a 2b                	push   $0x2b
  jmp alltraps
80105fde:	e9 99 f9 ff ff       	jmp    8010597c <alltraps>
...
80105fe5:	6a 2c                	push   $0x2c
  jmp alltraps
80105fe7:	e9 90 f9 ff ff       	jmp    8010597c <alltraps>
...
80105fee:	6a 2d                	push   $0x2d
  jmp alltraps
80105ff0:	e9 87 f9 ff ff       	jmp    8010597c <alltraps>
...
80105ff7:	6a 2e                	push   $0x2e
  jmp alltraps
80105ff9:	e9 7e f9 ff ff       	jmp    8010597c <alltraps>
...
80106000:	6a 2f                	push   $0x2f
  jmp alltraps
80106002:	e9 75 f9 ff ff       	jmp    8010597c <alltraps>
...
80106009:	6a 30                	push   $0x30
  jmp alltraps
8010600b:	e9 6c f9 ff ff       	jmp    8010597c <alltraps>
...
80106012:	6a 31                	push   $0x31
  jmp alltraps
80106014:	e9 63 f9 ff ff       	jmp    8010597c <alltraps>
...
8010601b:	6a 32                	push   $0x32
  jmp alltraps
8010601d:	e9 5a f9 ff ff       	jmp    8010597c <alltraps>
...
80106024:	6a 33                	push   $0x33
  jmp alltraps
80106026:	e9 51 f9 ff ff       	jmp    8010597c <alltraps>
...
8010602d:	6a 34                	push   $0x34
  jmp alltraps
8010602f:	e9 48 f9 ff ff       	jmp    8010597c <alltraps>
...
80106036:	6a 35                	push   $0x35
  jmp alltraps
80106038:	e9 3f f9 ff ff       	jmp    8010597c <alltraps>
...
8010603f:	6a 36                	push   $0x36
  jmp alltraps
80106041:	e9 36 f9 ff ff       	jmp    8010597c <alltraps>
...
80106048:	6a 37                	push   $0x37
  jmp alltraps
8010604a:	e9 2d f9 ff ff       	jmp    8010597c <alltraps>
...
80106051:	6a 38                	push   $0x38
  jmp alltraps
80106053:	e9 24 f9 ff ff       	jmp    8010597c <alltraps>
...
8010605a:	6a 39                	push   $0x39
  jmp alltraps
8010605c:	e9 1b f9 ff ff       	jmp    8010597c <alltraps>
...
80106063:	6a 3a                	push   $0x3a
  jmp alltraps
80106065:	e9 12 f9 ff ff       	jmp    8010597c <alltraps>
...
8010606c:	6a 3b                	push   $0x3b
  jmp alltraps
8010606e:	e9 09 f9 ff ff       	jmp    8010597c <alltraps>
...
80106075:	6a 3c                	push   $0x3c
  jmp alltraps
80106077:	e9 00 f9 ff ff       	jmp    8010597c <alltraps>
...
8010607e:	6a 3d                	push   $0x3d
  jmp alltraps
80106080:	e9 f7 f8 ff ff       	jmp    8010597c <alltraps>
...
80106087:	6a 3e                	push   $0x3e
  jmp alltraps
80106089:	e9 ee f8 ff ff       	jmp    8010597c <alltraps>
...
80106090:	6a 3f                	push   $0x3f
  jmp alltraps
80106092:	e9 e5 f8 ff ff       	jmp    8010597c <alltraps>
...
80106099:	6a 40                	push   $0x40
  jmp alltraps
8010609b:	e9 dc f8 ff ff       	jmp    8010597c <alltraps>
...
801060a2:	6a 41                	push   $0x41
  jmp alltraps
801060a4:	e9 d3 f8 ff ff       	jmp    8010597c <alltraps>
...
801060ab:	6a 42                	push   $0x42
  jmp alltraps
801060ad:	e9 ca f8 ff ff       	jmp    8010597c <alltraps>
...
801060b4:	6a 43                	push   $0x43
  jmp alltraps
801060b6:	e9 c1 f8 ff ff       	jmp    8010597c <alltraps>
...
801060bd:	6a 44                	push   $0x44
  jmp alltraps
801060bf:	e9 b8 f8 ff ff       	jmp    8010597c <alltraps>
...
801060c6:	6a 45                	push   $0x45
  jmp alltraps
801060c8:	e9 af f8 ff ff       	jmp    8010597c <alltraps>
...
801060cf:	6a 46                	push   $0x46
  jmp alltraps
801060d1:	e9 a6 f8 ff ff       	jmp    8010597c <alltraps>
...
801060d8:	6a 47                	push   $0x47
  jmp alltraps
801060da:	e9 9d f8 ff ff       	jmp    8010597c <alltraps>
...
801060e1:	6a 48                	push   $0x48
  jmp alltraps
801060e3:	e9 94 f8 ff ff       	jmp    8010597c <alltraps>
...
801060ea:	6a 49                	push   $0x49
  jmp alltraps
801060ec:	e9 8b f8 ff ff       	jmp    8010597c <alltraps>
...
801060f3:	6a 4a                	push   $0x4a
  jmp alltraps
801060f5:	e9 82 f8 ff ff       	jmp    8010597c <alltraps>
...
801060fc:	6a 4b                	push   $0x4b
  jmp alltraps
801060fe:	e9 79 f8 ff ff       	jmp    8010597c <alltraps>
...
80106105:	6a 4c                	push   $0x4c
  jmp alltraps
80106107:	e9 70 f8 ff ff       	jmp    8010597c <alltraps>
...
8010610e:	6a 4d                	push   $0x4d
  jmp alltraps
80106110:	e9 67 f8 ff ff       	jmp    8010597c <alltraps>
...
80106117:	6a 4e                	push   $0x4e
  jmp alltraps
80106119:	e9 5e f8 ff ff       	jmp    8010597c <alltraps>
...
80106120:	6a 4f                	push   $0x4f
  jmp alltraps
80106122:	e9 55 f8 ff ff       	jmp    8010597c <alltraps>
...
80106129:	6a 50                	push   $0x50
  jmp alltraps
8010612b:	e9 4c f8 ff ff       	jmp    8010597c <alltraps>
...
80106132:	6a 51                	push   $0x51
  jmp alltraps
80106134:	e9 43 f8 ff ff       	jmp    8010597c <alltraps>
...
8010613b:	6a 52                	push   $0x52
  jmp alltraps
8010613d:	e9 3a f8 ff ff       	jmp    8010597c <alltraps>
...
80106144:	6a 53                	push   $0x53
  jmp alltraps
80106146:	e9 31 f8 ff ff       	jmp    8010597c <alltraps>
...
8010614d:	6a 54                	push   $0x54
  jmp alltraps
8010614f:	e9 28 f8 ff ff       	jmp    8010597c <alltraps>
...
80106156:	6a 55                	push   $0x55
  jmp alltraps
80106158:	e9 1f f8 ff ff       	jmp    8010597c <alltraps>
...
8010615f:	6a 56                	push   $0x56
  jmp alltraps
80106161:	e9 16 f8 ff ff       	jmp    8010597c <alltraps>
...
80106168:	6a 57                	push   $0x57
  jmp alltraps
8010616a:	e9 0d f8 ff ff       	jmp    8010597c <alltraps>
...
80106171:	6a 58                	push   $0x58
  jmp alltraps
80106173:	e9 04 f8 ff ff       	jmp    8010597c <alltraps>
...
8010617a:	6a 59                	push   $0x59
  jmp alltraps
8010617c:	e9 fb f7 ff ff       	jmp    8010597c <alltraps>
...
80106183:	6a 5a                	push   $0x5a
  jmp alltraps
80106185:	e9 f2 f7 ff ff       	jmp    8010597c <alltraps>
...
8010618c:	6a 5b                	push   $0x5b
  jmp alltraps
8010618e:	e9 e9 f7 ff ff       	jmp    8010597c <alltraps>
...
80106195:	6a 5c                	push   $0x5c
  jmp alltraps
80106197:	e9 e0 f7 ff ff       	jmp    8010597c <alltraps>
...
8010619e:	6a 5d                	push   $0x5d
  jmp alltraps
801061a0:	e9 d7 f7 ff ff       	jmp    8010597c <alltraps>
...
801061a7:	6a 5e                	push   $0x5e
  jmp alltraps
801061a9:	e9 ce f7 ff ff       	jmp    8010597c <alltraps>
...
801061b0:	6a 5f                	push   $0x5f
  jmp alltraps
801061b2:	e9 c5 f7 ff ff       	jmp    8010597c <alltraps>
...
801061b9:	6a 60                	push   $0x60
  jmp alltraps
801061bb:	e9 bc f7 ff ff       	jmp    8010597c <alltraps>
...
801061c2:	6a 61                	push   $0x61
  jmp alltraps
801061c4:	e9 b3 f7 ff ff       	jmp    8010597c <alltraps>
...
801061cb:	6a 62                	push   $0x62
  jmp alltraps
801061cd:	e9 aa f7 ff ff       	jmp    8010597c <alltraps>
...
801061d4:	6a 63                	push   $0x63
  jmp alltraps
801061d6:	e9 a1 f7 ff ff       	jmp    8010597c <alltraps>
...
801061dd:	6a 64                	push   $0x64
  jmp alltraps
801061df:	e9 98 f7 ff ff       	jmp    8010597c <alltraps>
...
801061e6:	6a 65                	push   $0x65
  jmp alltraps
801061e8:	e9 8f f7 ff ff       	jmp    8010597c <alltraps>
...
801061ef:	6a 66                	push   $0x66
  jmp alltraps
801061f1:	e9 86 f7 ff ff       	jmp    8010597c <alltraps>
...
801061f8:	6a 67                	push   $0x67
  jmp alltraps
801061fa:	e9 7d f7 ff ff       	jmp    8010597c <alltraps>
...
80106201:	6a 68                	push   $0x68
  jmp alltraps
80106203:	e9 74 f7 ff ff       	jmp    8010597c <alltraps>
...
8010620a:	6a 69                	push   $0x69
  jmp alltraps
8010620c:	e9 6b f7 ff ff       	jmp    8010597c <alltraps>
...
80106213:	6a 6a                	push   $0x6a
  jmp alltraps
80106215:	e9 62 f7 ff ff       	jmp    8010597c <alltraps>
...
8010621c:	6a 6b                	push   $0x6b
  jmp alltraps
8010621e:	e9 59 f7 ff ff       	jmp    8010597c <alltraps>
...
80106225:	6a 6c                	push   $0x6c
  jmp alltraps
80106227:	e9 50 f7 ff ff       	jmp    8010597c <alltraps>
...
8010622e:	6a 6d                	push   $0x6d
  jmp alltraps
80106230:	e9 47 f7 ff ff       	jmp    8010597c <alltraps>
...
80106237:	6a 6e                	push   $0x6e
  jmp alltraps
80106239:	e9 3e f7 ff ff       	jmp    8010597c <alltraps>
...
80106240:	6a 6f                	push   $0x6f
  jmp alltraps
80106242:	e9 35 f7 ff ff       	jmp    8010597c <alltraps>
...
80106249:	6a 70                	push   $0x70
  jmp alltraps
8010624b:	e9 2c f7 ff ff       	jmp    8010597c <alltraps>
...
80106252:	6a 71                	push   $0x71
  jmp alltraps
80106254:	e9 23 f7 ff ff       	jmp    8010597c <alltraps>
...
8010625b:	6a 72                	push   $0x72
  jmp alltraps
8010625d:	e9 1a f7 ff ff       	jmp    8010597c <alltraps>
...
80106264:	6a 73                	push   $0x73
  jmp alltraps
80106266:	e9 11 f7 ff ff       	jmp    8010597c <alltraps>
...
8010626d:	6a 74                	push   $0x74
  jmp alltraps
8010626f:	e9 08 f7 ff ff       	jmp    8010597c <alltraps>
...
80106276:	6a 75                	push   $0x75
  jmp alltraps
80106278:	e9 ff f6 ff ff       	jmp    8010597c <alltraps>
...
8010627f:	6a 76                	push   $0x76
  jmp alltraps
80106281:	e9 f6 f6 ff ff       	jmp    8010597c <alltraps>
...
80106288:	6a 77                	push   $0x77
  jmp alltraps
8010628a:	e9 ed f6 ff ff       	jmp    8010597c <alltraps>
...
80106291:	6a 78                	push   $0x78
  jmp alltraps
80106293:	e9 e4 f6 ff ff       	jmp    8010597c <alltraps>
...
8010629a:	6a 79                	push   $0x79
  jmp alltraps
8010629c:	e9 db f6 ff ff       	jmp    8010597c <alltraps>
...
801062a3:	6a 7a                	push   $0x7a
  jmp alltraps
801062a5:	e9 d2 f6 ff ff       	jmp    8010597c <alltraps>
...
801062ac:	6a 7b                	push   $0x7b
  jmp alltraps
801062ae:	e9 c9 f6 ff ff       	jmp    8010597c <alltraps>
...
801062b5:	6a 7c                	push   $0x7c
  jmp alltraps
801062b7:	e9 c0 f6 ff ff       	jmp    8010597c <alltraps>
...
801062be:	6a 7d                	push   $0x7d
  jmp alltraps
801062c0:	e9 b7 f6 ff ff       	jmp    8010597c <alltraps>
...
801062c7:	6a 7e                	push   $0x7e
  jmp alltraps
801062c9:	e9 ae f6 ff ff       	jmp    8010597c <alltraps>
...
801062d0:	6a 7f                	push   $0x7f
  jmp alltraps
801062d2:	e9 a5 f6 ff ff       	jmp    8010597c <alltraps>
...
801062d9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801062de:	e9 99 f6 ff ff       	jmp    8010597c <alltraps>
...
801062e5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801062ea:	e9 8d f6 ff ff       	jmp    8010597c <alltraps>
...
801062f1:	68 82 00 00 00       	push   $0x82
  jmp alltraps
801062f6:	e9 81 f6 ff ff       	jmp    8010597c <alltraps>
...
801062fd:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106302:	e9 75 f6 ff ff       	jmp    8010597c <alltraps>
...
80106309:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010630e:	e9 69 f6 ff ff       	jmp    8010597c <alltraps>
...
80106315:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010631a:	e9 5d f6 ff ff       	jmp    8010597c <alltraps>
...
80106321:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106326:	e9 51 f6 ff ff       	jmp    8010597c <alltraps>
...
8010632d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106332:	e9 45 f6 ff ff       	jmp    8010597c <alltraps>
...
80106339:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010633e:	e9 39 f6 ff ff       	jmp    8010597c <alltraps>
...
80106345:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010634a:	e9 2d f6 ff ff       	jmp    8010597c <alltraps>
...
80106351:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106356:	e9 21 f6 ff ff       	jmp    8010597c <alltraps>
...
8010635d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106362:	e9 15 f6 ff ff       	jmp    8010597c <alltraps>
...
80106369:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010636e:	e9 09 f6 ff ff       	jmp    8010597c <alltraps>
...
80106375:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010637a:	e9 fd f5 ff ff       	jmp    8010597c <alltraps>
...
80106381:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106386:	e9 f1 f5 ff ff       	jmp    8010597c <alltraps>
...
8010638d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106392:	e9 e5 f5 ff ff       	jmp    8010597c <alltraps>
...
80106399:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010639e:	e9 d9 f5 ff ff       	jmp    8010597c <alltraps>
...
801063a5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801063aa:	e9 cd f5 ff ff       	jmp    8010597c <alltraps>
...
801063b1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801063b6:	e9 c1 f5 ff ff       	jmp    8010597c <alltraps>
...
801063bd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801063c2:	e9 b5 f5 ff ff       	jmp    8010597c <alltraps>
...
801063c9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801063ce:	e9 a9 f5 ff ff       	jmp    8010597c <alltraps>
...
801063d5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801063da:	e9 9d f5 ff ff       	jmp    8010597c <alltraps>
...
801063e1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801063e6:	e9 91 f5 ff ff       	jmp    8010597c <alltraps>
...
801063ed:	68 97 00 00 00       	push   $0x97
  jmp alltraps
801063f2:	e9 85 f5 ff ff       	jmp    8010597c <alltraps>
...
801063f9:	68 98 00 00 00       	push   $0x98
  jmp alltraps
801063fe:	e9 79 f5 ff ff       	jmp    8010597c <alltraps>
...
80106405:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010640a:	e9 6d f5 ff ff       	jmp    8010597c <alltraps>
...
80106411:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106416:	e9 61 f5 ff ff       	jmp    8010597c <alltraps>
...
8010641d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106422:	e9 55 f5 ff ff       	jmp    8010597c <alltraps>
...
80106429:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010642e:	e9 49 f5 ff ff       	jmp    8010597c <alltraps>
...
80106435:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010643a:	e9 3d f5 ff ff       	jmp    8010597c <alltraps>
...
80106441:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106446:	e9 31 f5 ff ff       	jmp    8010597c <alltraps>
...
8010644d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106452:	e9 25 f5 ff ff       	jmp    8010597c <alltraps>
...
80106459:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010645e:	e9 19 f5 ff ff       	jmp    8010597c <alltraps>
...
80106465:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010646a:	e9 0d f5 ff ff       	jmp    8010597c <alltraps>
...
80106471:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106476:	e9 01 f5 ff ff       	jmp    8010597c <alltraps>
...
8010647d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106482:	e9 f5 f4 ff ff       	jmp    8010597c <alltraps>
...
80106489:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010648e:	e9 e9 f4 ff ff       	jmp    8010597c <alltraps>
...
80106495:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010649a:	e9 dd f4 ff ff       	jmp    8010597c <alltraps>
...
801064a1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801064a6:	e9 d1 f4 ff ff       	jmp    8010597c <alltraps>
...
801064ad:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801064b2:	e9 c5 f4 ff ff       	jmp    8010597c <alltraps>
...
801064b9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801064be:	e9 b9 f4 ff ff       	jmp    8010597c <alltraps>
...
801064c5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801064ca:	e9 ad f4 ff ff       	jmp    8010597c <alltraps>
...
801064d1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801064d6:	e9 a1 f4 ff ff       	jmp    8010597c <alltraps>
...
801064dd:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801064e2:	e9 95 f4 ff ff       	jmp    8010597c <alltraps>
...
801064e9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801064ee:	e9 89 f4 ff ff       	jmp    8010597c <alltraps>
...
801064f5:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
801064fa:	e9 7d f4 ff ff       	jmp    8010597c <alltraps>
...
80106501:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106506:	e9 71 f4 ff ff       	jmp    8010597c <alltraps>
...
8010650d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106512:	e9 65 f4 ff ff       	jmp    8010597c <alltraps>
...
80106519:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010651e:	e9 59 f4 ff ff       	jmp    8010597c <alltraps>
...
80106525:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010652a:	e9 4d f4 ff ff       	jmp    8010597c <alltraps>
...
80106531:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106536:	e9 41 f4 ff ff       	jmp    8010597c <alltraps>
...
8010653d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106542:	e9 35 f4 ff ff       	jmp    8010597c <alltraps>
...
80106549:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010654e:	e9 29 f4 ff ff       	jmp    8010597c <alltraps>
...
80106555:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010655a:	e9 1d f4 ff ff       	jmp    8010597c <alltraps>
...
80106561:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106566:	e9 11 f4 ff ff       	jmp    8010597c <alltraps>
...
8010656d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106572:	e9 05 f4 ff ff       	jmp    8010597c <alltraps>
...
80106579:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010657e:	e9 f9 f3 ff ff       	jmp    8010597c <alltraps>
...
80106585:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010658a:	e9 ed f3 ff ff       	jmp    8010597c <alltraps>
...
80106591:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106596:	e9 e1 f3 ff ff       	jmp    8010597c <alltraps>
...
8010659d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801065a2:	e9 d5 f3 ff ff       	jmp    8010597c <alltraps>
...
801065a9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801065ae:	e9 c9 f3 ff ff       	jmp    8010597c <alltraps>
...
801065b5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801065ba:	e9 bd f3 ff ff       	jmp    8010597c <alltraps>
...
801065c1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801065c6:	e9 b1 f3 ff ff       	jmp    8010597c <alltraps>
...
801065cd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801065d2:	e9 a5 f3 ff ff       	jmp    8010597c <alltraps>
...
801065d9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801065de:	e9 99 f3 ff ff       	jmp    8010597c <alltraps>
...
801065e5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801065ea:	e9 8d f3 ff ff       	jmp    8010597c <alltraps>
...
801065f1:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
801065f6:	e9 81 f3 ff ff       	jmp    8010597c <alltraps>
...
801065fd:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106602:	e9 75 f3 ff ff       	jmp    8010597c <alltraps>
...
80106609:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010660e:	e9 69 f3 ff ff       	jmp    8010597c <alltraps>
...
80106615:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010661a:	e9 5d f3 ff ff       	jmp    8010597c <alltraps>
...
80106621:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106626:	e9 51 f3 ff ff       	jmp    8010597c <alltraps>
...
8010662d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106632:	e9 45 f3 ff ff       	jmp    8010597c <alltraps>
...
80106639:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010663e:	e9 39 f3 ff ff       	jmp    8010597c <alltraps>
...
80106645:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010664a:	e9 2d f3 ff ff       	jmp    8010597c <alltraps>
...
80106651:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106656:	e9 21 f3 ff ff       	jmp    8010597c <alltraps>
...
8010665d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106662:	e9 15 f3 ff ff       	jmp    8010597c <alltraps>
...
80106669:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010666e:	e9 09 f3 ff ff       	jmp    8010597c <alltraps>
...
80106675:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010667a:	e9 fd f2 ff ff       	jmp    8010597c <alltraps>
...
80106681:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106686:	e9 f1 f2 ff ff       	jmp    8010597c <alltraps>
...
8010668d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106692:	e9 e5 f2 ff ff       	jmp    8010597c <alltraps>
...
80106699:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010669e:	e9 d9 f2 ff ff       	jmp    8010597c <alltraps>
...
801066a5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801066aa:	e9 cd f2 ff ff       	jmp    8010597c <alltraps>
...
801066b1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801066b6:	e9 c1 f2 ff ff       	jmp    8010597c <alltraps>
...
801066bd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801066c2:	e9 b5 f2 ff ff       	jmp    8010597c <alltraps>
...
801066c9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801066ce:	e9 a9 f2 ff ff       	jmp    8010597c <alltraps>
...
801066d5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801066da:	e9 9d f2 ff ff       	jmp    8010597c <alltraps>
...
801066e1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801066e6:	e9 91 f2 ff ff       	jmp    8010597c <alltraps>
...
801066ed:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
801066f2:	e9 85 f2 ff ff       	jmp    8010597c <alltraps>
...
801066f9:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
801066fe:	e9 79 f2 ff ff       	jmp    8010597c <alltraps>
...
80106705:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010670a:	e9 6d f2 ff ff       	jmp    8010597c <alltraps>
...
80106711:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106716:	e9 61 f2 ff ff       	jmp    8010597c <alltraps>
...
8010671d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106722:	e9 55 f2 ff ff       	jmp    8010597c <alltraps>
...
80106729:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010672e:	e9 49 f2 ff ff       	jmp    8010597c <alltraps>
...
80106735:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010673a:	e9 3d f2 ff ff       	jmp    8010597c <alltraps>
...
80106741:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106746:	e9 31 f2 ff ff       	jmp    8010597c <alltraps>
...
8010674d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106752:	e9 25 f2 ff ff       	jmp    8010597c <alltraps>
...
80106759:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010675e:	e9 19 f2 ff ff       	jmp    8010597c <alltraps>
...
80106765:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010676a:	e9 0d f2 ff ff       	jmp    8010597c <alltraps>
...
80106771:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106776:	e9 01 f2 ff ff       	jmp    8010597c <alltraps>
...
8010677d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106782:	e9 f5 f1 ff ff       	jmp    8010597c <alltraps>
...
80106789:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010678e:	e9 e9 f1 ff ff       	jmp    8010597c <alltraps>
...
80106795:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010679a:	e9 dd f1 ff ff       	jmp    8010597c <alltraps>
...
801067a1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801067a6:	e9 d1 f1 ff ff       	jmp    8010597c <alltraps>
...
801067ad:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801067b2:	e9 c5 f1 ff ff       	jmp    8010597c <alltraps>
...
801067b9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801067be:	e9 b9 f1 ff ff       	jmp    8010597c <alltraps>
...
801067c5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801067ca:	e9 ad f1 ff ff       	jmp    8010597c <alltraps>
...
801067d1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801067d6:	e9 a1 f1 ff ff       	jmp    8010597c <alltraps>
...
801067dd:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801067e2:	e9 95 f1 ff ff       	jmp    8010597c <alltraps>
...
801067e9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801067ee:	e9 89 f1 ff ff       	jmp    8010597c <alltraps>
...
801067f5:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
801067fa:	e9 7d f1 ff ff       	jmp    8010597c <alltraps>
...
80106801:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106806:	e9 71 f1 ff ff       	jmp    8010597c <alltraps>
...
8010680d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106812:	e9 65 f1 ff ff       	jmp    8010597c <alltraps>
...
80106819:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010681e:	e9 59 f1 ff ff       	jmp    8010597c <alltraps>
...
80106825:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010682a:	e9 4d f1 ff ff       	jmp    8010597c <alltraps>
...
80106831:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106836:	e9 41 f1 ff ff       	jmp    8010597c <alltraps>
...
8010683d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106842:	e9 35 f1 ff ff       	jmp    8010597c <alltraps>
...
80106849:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010684e:	e9 29 f1 ff ff       	jmp    8010597c <alltraps>
...
80106855:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010685a:	e9 1d f1 ff ff       	jmp    8010597c <alltraps>
...
80106861:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106866:	e9 11 f1 ff ff       	jmp    8010597c <alltraps>
...
8010686d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106872:	e9 05 f1 ff ff       	jmp    8010597c <alltraps>
...
80106879:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010687e:	e9 f9 f0 ff ff       	jmp    8010597c <alltraps>
...
80106885:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010688a:	e9 ed f0 ff ff       	jmp    8010597c <alltraps>
...
80106891:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106896:	e9 e1 f0 ff ff       	jmp    8010597c <alltraps>
...
8010689d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801068a2:	e9 d5 f0 ff ff       	jmp    8010597c <alltraps>
...
801068a9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801068ae:	e9 c9 f0 ff ff       	jmp    8010597c <alltraps>
...
801068b5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801068ba:	e9 bd f0 ff ff       	jmp    8010597c <alltraps>
...
801068c1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801068c6:	e9 b1 f0 ff ff       	jmp    8010597c <alltraps>
...
801068cd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801068d2:	e9 a5 f0 ff ff       	jmp    8010597c <alltraps>
...
80106a25:	e8 36 dc ff ff       	call   80104660 <memset>
...
80106a83:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106a86:	e8 c5 ce ff ff       	call   80103950 <cpuid>
  pd[0] = size-1;
...
80106b10:	a1 e4 44 11 80       	mov    0x801144e4,%eax
...
80106b44:	0f 84 c2 00 00 00    	je     80106c0c <switchuvm+0xec>
  pushcli();
80106b4a:	e8 01 d9 ff ff       	call   80104450 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106b4f:	e8 9c cd ff ff       	call   801038f0 <mycpu>
80106b54:	89 c3                	mov    %eax,%ebx
80106b56:	e8 95 cd ff ff       	call   801038f0 <mycpu>
...
80106b68:	e8 83 cd ff ff       	call   801038f0 <mycpu>
...
80106bb1:	e8 3a cd ff ff       	call   801038f0 <mycpu>
...
80106bcf:	e8 1c cd ff ff       	call   801038f0 <mycpu>
80106bd4:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106bd7:	e8 14 cd ff ff       	call   801038f0 <mycpu>
...
80106bf9:	5d                   	pop    %ebp
  popcli();
80106bfa:	e9 a1 d8 ff ff       	jmp    801044a0 <popcli>
...
80106c5f:	e8 fc d9 ff ff       	call   80104660 <memset>
...
80106c92:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c93:	e9 68 da ff ff       	jmp    80104700 <memmove>
...
80106deb:	e8 70 d8 ff ff       	call   80104660 <memset>
...
80106fa0:	e8 bb d6 ff ff       	call   80104660 <memset>
...
8010700b:	a3 e4 44 11 80       	mov    %eax,0x801144e4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80107240:	e8 bb d4 ff ff       	call   80104700 <memmove>
    len -= n;
    buf += n;
